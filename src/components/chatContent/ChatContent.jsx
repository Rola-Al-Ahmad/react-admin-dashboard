    ...
    const addChatItem = (newItem) => {
        if (currentMessage.trim() !== '') {
            ...
            const newChatItem = {
                ...
                type: '',
                msg: currentMessage,
                deliveryTime: now.toLocaleTimeString('en-US', { hour: 'numeric', minute: 'numeric' }),
        ...
        <div className="main__chatcontent">
                    ...
                    <div className="current-chatting-user">
                        <div className="avatar">
                            <div className="avatarImg">
                                <img src="./assets/rolaa.jpeg" alt="Rola Al-Ahmad" />
                            </div>
                        </div>
                        <p>Rola Al-Ahmad</p>
                    </div>
            ...
            <div className="content__footer">
                <div className="sendNewMessage">
                    ...
                    />
                    <SendIcon className="btnSendMsg" id="sendMsgBtn" onClick={addChatItem} />
                </div>
            </div>
        </div>
    );
